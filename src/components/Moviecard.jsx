...
const MovieCard = (props) => {
  ...
  const handleMovieInfo = (imdbID) => {
    navigate("/MovieInfo", { state: imdbID })
  }
  return (
    <>
      <div className="movie movie-hover-content relative bg-[#343739] rounded-lg overflow-hidden  m-6 w-80 h-96" key={imdbID} onClick={() => {
        handleMovieInfo(imdbID)
      }}>
